"""Support for otodata ble sensors."""
from __future__ import annotations

from typing import Optional, Union

from .otodata_ble import DeviceClass, DeviceKey, SensorUpdate, Units
...
def sensor_update_to_bluetooth_data_update(
    ...
    # _LOGGER.debug("Enter Otodata sensor_update_to_bluetooth_data_update")
    # _LOGGER.debug("Parsing Otodata BLE service_info data: %s", sensor_update.entity_values.items())
...
async def async_setup_entry(
    ...
    """Set up the Otodata BLE sensors."""
    ...
    entry.async_on_unload(
        processor.async_add_entities_listener(
            OtodataBluetoothSensorEntity, async_add_entities
        )
    )
    entry.async_on_unload(coordinator.async_register_processor(processor))


class OtodataBluetoothSensorEntity(
    PassiveBluetoothProcessorEntity[
    ...
    """Representation of a otodata ble sensor."""
